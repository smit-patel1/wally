...
cd <ros2_ws>
. install/setup.bash # use setup.zsh if use zsh
ros2 launch wally_fastlio mapping.launch.py config_file:=avia.yaml
```
...
Run:
```bash
ros2 launch wally_fastlio mapping.launch.py config_path:=<path_to_your_config_file>
...
Run:
```
roslaunch wally_fastlio mapping_velodyne.launch
